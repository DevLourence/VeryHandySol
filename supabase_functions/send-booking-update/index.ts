...
serve(async (req: Request) => {
    ...
    try {
        ...
        if (type === 'admin_new_booking' || type === 'admin_new_review') {
            ...
            recipientList = admins.map((a: { email: string }) => a.email).filter((e: string | null) => e);
        ...
        if (type === 'admin_new_booking') {
            ...
            <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <a href="https://veryhandysolution.com/admin_dashboard.html" style="background-color: #4f46e5; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Open Admin Dashboard</a>
            </div>`;
        }
        ...
        // B. ADMIN: NEW REVIEW
            ...
            <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <a href="https://veryhandysolution.com/admin_dashboard.html" style="background-color: #111827; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Review & Approve</a>
            </div>`;
        }
        ...
        // C. CLIENT: STATUS UPDATE (Original Logic)
            ...
            htmlContent = `
            <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                <h2 style="color: #4f46e5; text-transform: uppercase;">VeryHandy Solution</h2>
                <h1>Hello ${name},</h1>
                ...
                <p style="font-size: 12px; color: #9ca3af; text-align: center;">VeryHandy Solution | Professional Home Maintenance & Repairs</p>
            </div>`;
        }
        ...
        const res = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'VeryHandy Solution <onboarding@resend.dev>', // Default Resend test domain
